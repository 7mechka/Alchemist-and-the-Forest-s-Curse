...
define config.name = _("Saint Alchemist and Lost Maiden")
...
define build.name = "SaintAlchemistandLostMaiden"
...
define config.save_directory = "SaintAlchemistandLostMaiden-1746136859"
