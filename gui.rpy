...
define gui.choice_button_text_idle_color = '#323131'
define gui.choice_button_text_hover_color = "#323131"
define gui.choice_button_text_insensitive_color = '#7070707f'

define gui.choice_button_background_idle_color = "#dad9d9"    # Фон в покое
define gui.choice_button_background_hover_color = "#ffffff"   # Фон при наведении

define gui.choice_button_border_color = "#0099ff"  # Цвет границ
define gui.choice_button_hover_border_color = "#ffffff"  # При наведении
