...
style choice_button is default:
    ...
    background Solid(gui.choice_button_background_idle_color)
    hover_background Solid(gui.choice_button_background_hover_color)
...
#     background Solid(gui.choice_button_background_idle_color)
#     hover_background Solid(gui.choice_button_background_hover_color)
#     padding (25, 5)  # Отступы внутри кнопки
